!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(t)
    : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).SlimSelect = t());
})(this, function () {
  'use strict';
  function e() {
  ...
  class a {
    ...
    setData(e) {
      (this.data = this.partialToFullData(e)),
        'single' === this.selectType && this.setSelectedBy('value', this.getSelected());
    }
    getData() {
      ...
      for (let l of this.data) {
        if (l instanceof i)
          for (let i of l.options)
            s || (s = i), (i.selected = !a && t.includes(i[e])), i.selected && 'single' === this.selectType && (a = !0);
        l instanceof n &&
          (s || (s = l), (l.selected = !a && t.includes(l[e])), l.selected && 'single' === this.selectType && (a = !0));
      }
    ...
    getFirstOption() {
      let e = null;
      for (let t of this.data) if ((t instanceof i ? (e = t.options[0]) : t instanceof n && (e = t), e)) break;
      return e;
    }
    search(e, t) {
  ...
  class l {
    ...
    open() {
      this.main.arrow.path.setAttribute('d', this.classes.arrowOpen),
        this.main.main.classList.add(
          'up' === this.settings.openPosition ? this.classes.openAbove : this.classes.openBelow
        ),
    ...
    mainDiv() {
      ...
      !this.settings.allowDeselect || (this.settings.isMultiple && n && n.length <= 0)
      ...
      return (
        ...
        o.appendChild(c),
        t.appendChild(o),
        { main: t, values: s, deselect: { main: i, svg: a, path: l }, arrow: { main: o, path: c } }
      );
    }
    mainFocus(e) {
      ...
      for (let s = 0; s < t.length; s++) {
        ...
        i &&
          (this.settings.keepOrder || 0 === e.length
            ...
            : e[s - 1].insertAdjacentElement('afterend', this.multipleValue(t[s])));
      }
    }
    multipleValue(e) {
      const t = document.createElement('div');
      ...
      if ((s.classList.add(this.classes.valueText), (s.innerText = e.text), t.appendChild(s), !e.mandatory)) {
        ...
        s.classList.add(this.classes.valueDelete),
          (s.onclick = t => {
            ...
            if (
              !(this.settings.minSelected && l.length < this.settings.minSelected) &&
              (this.callbacks.beforeChange && (s = !0 === this.callbacks.beforeChange(l, a)), s)
            ) {
              let e = [];
              for (const t of l) {
        ...
        a.setAttribute('viewBox', '0 0 100 100');
        const l = document.createElementNS('http://www.w3.org/2000/svg', 'path');
        l.setAttribute('d', this.classes.optionDelete), a.appendChild(l), s.appendChild(a), t.appendChild(s);
      }
      return t;
    }
    contentDiv() {
    ...
    moveContent() {
      'relative' !== this.settings.contentPosition && 'down' !== this.settings.openPosition
    ...
    searchDiv() {
      ...
      if (
        (this.settings.showSearch || (e.classList.add(this.classes.hide), (s.readOnly = !0)),
        (s.type = 'search'),
    ...
    renderOptions(e) {
      ...
      for (const t of e) {
        if (t instanceof i) {
          ...
          if (
            (n.classList.add(this.classes.optgroupActions), s.appendChild(n), this.settings.isMultiple && t.selectAll)
          ) {
            const e = document.createElement('div');
          ...
          if ('off' !== t.closable) {
            ...
            const l = document.createElementNS('http://www.w3.org/2000/svg', 'path');
            a.appendChild(l),
              t.options.some(e => e.selected) || '' !== this.content.search.input.value.trim()
                ? (i.classList.add(this.classes.open), l.setAttribute('d', this.classes.arrowOpen))
                : 'open' === t.closable
                ? (e.classList.add(this.classes.open), l.setAttribute('d', this.classes.arrowOpen))
                : 'close' === t.closable &&
                  (e.classList.add(this.classes.close), l.setAttribute('d', this.classes.arrowClose)),
    ...
    option(e) {
      ...
      return (
        ...
        e.selected
          ...
          : (t.classList.remove(this.classes.selected), t.setAttribute('aria-selected', 'false')),
        t.addEventListener('click', t => {
          ...
          if (
            (this.settings.isMultiple && this.settings.maxSelected <= s.length && !e.selected) ||
            (this.settings.isMultiple && this.settings.minSelected >= s.length && e.selected)
          )
            return;
          let a = !1;
    ...
    moveContentBelow() {
      ...
      (this.content.main.style.margin = '-1px 0px 0px 0px'),
        'relative' !== this.settings.contentPosition &&
          ((this.content.main.style.top = e.top + e.height + window.scrollY + 'px'),
    ...
    observeCall(e) {
      ...
      for (const n of e)
        n.target === this.select &&
          ('disabled' === n.attributeName && (s = !0), 'class' === n.attributeName && (t = !0)),
  ...
  return class {
    constructor(e) {
      ...
      if ('SELECT' !== this.selectEl.tagName)
        return void (e.events && e.events.error && e.events.error(new Error('Element isnt of type select')));
      this.selectEl.dataset.ssid && this.destroy(), (this.settings = new c(e.settings));
      const i = ['afterChange', 'beforeOpen', 'afterOpen', 'beforeClose', 'afterClose'];
      for (const s in e.events)
        e.events.hasOwnProperty(s) &&
          (-1 !== i.indexOf(s) ? (this.events[s] = t(e.events[s], 100)) : (this.events[s] = e.events[s]));
      (this.settings.disabled = (null === (s = e.settings) || void 0 === s ? void 0 : s.disabled)
        ? e.settings.disabled
        ...
        (this.store = new a(this.settings.isMultiple ? 'multiple' : 'single', e.data ? e.data : this.select.getData())),
    ...
    search(e) {
      if (
        (this.render.content.search.input.value !== e && (this.render.content.search.input.value = e),
        !this.events.search)
      )
