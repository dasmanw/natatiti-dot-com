...
class SalesmanDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('status', function ($salesman) {
                return view('content.user.salesman.partials.status', compact('salesman'));
            })
            ->addColumn('action', function ($salesman) {
                return view('content.user.salesman.partials.actions', compact('salesman'));
            });
    }
